...
public class Input {
    ...
    /** @param id of a key @return only true the first cycle the button is held down */
    public static boolean keyClick(int keyID) {
        return keyInputs[keyID] == 2;
    }
    /** @param keyCode.somekey @return only true the first cycle the key is held down */
    public static boolean keyClick(KeyCodes keyID) {
        return keyInputs[keyID.getCode()] == 2;
    }
    
    /** @param id of a key @return if key is held */
    public static boolean keyDown(int keyID) {
        return keyInputs[keyID] > 0;
    }
    /** @param keyCode.somekey @return if key is held */
    public static boolean keyDown(KeyCodes keyID) {
        return keyInputs[keyID.getCode()] > 0;
    }
}